import{d as p,Y as d,I as _,b as a,e as t,x as s,z as r,F as h,X as u,o as n,Z as f,l as g,g as v}from"../modules/vue-Dpzh9dbX.js";import{k as x,c as m,f as b,t as k,b as y}from"../index-CCFmU1it.js";import{N}from"./NoteDisplay-BmE1AtSE.js";import"../modules/shiki-BE4Gqpus.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},D={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},j=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-main mb-8"},C=p({__name:"print",setup(F){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
